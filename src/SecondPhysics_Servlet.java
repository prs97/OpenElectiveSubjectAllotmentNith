...
public class SecondPhysics_Servlet extends HttpServlet {
	...
	//	System.out.println("third if");
				if(first==0&&(rs1.getString("SECONDCHOICE").equals("physics")))
				{
		...
		RequestDispatcher rd=request.getRequestDispatcher("chesecond");
